...
const appCss = "/assets/styles-nAu0ml7A.css";
...
const $$splitComponentImporter = () => import("./index-qsG78JGT.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "FLOWCODE AI builds modern websites, AI chatbots, and business automation systems that save time, generate leads, and grow revenue."
    }, {
      property: "og:title",
      content: "FLOWCODE AI — AI-Powered Websites & Business Automation"
    }, {
      property: "og:description",
      content: "Modern websites, AI chatbots, and automation systems for businesses that want to scale faster."
    }, {
      property: "og:type",
      content: "website"
    }]
